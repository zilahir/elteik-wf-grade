...
EXERCISE1 - HTML5 / CSS ALAPOK (1.)
    ...
    Run Keyword If            "${IsPageTitleOk[0]}" == "PASS"  Evaluate    ${FinalPoints}+10
    ...
    Run Keyword If            "${IsDoctypeOk[0]}" == "PASS"  Evaluate    ${FinalPoints}+30
    ...
    Run Keyword If            "${RedColorResult}" == "PASS"  Evaluate    ${FinalPoints}+30
    ...
    Run Keyword If            "${IsTextUnderlined}" == "PASS"  Evaluate    ${FinalPoints}+30
